...
public class OnlineMapsControlBase : MonoBehaviour
{
    ...
    {
        Vector2 pos = OnlineMapsUtils.LatLongToTilef(coords, api.buffer.apiZoom);
        Vector2 topLeft = OnlineMapsUtils.LatLongToTilef(api.topLeftPosition, api.buffer.apiZoom);
        pos -= topLeft;
